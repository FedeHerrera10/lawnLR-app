        ...
        >
          ...
          >
            <View className="bg-white/95 rounded-3xl shadow-xl p-6 mt-10">
              ...
              <Controller
                ...
                render={({ field: { onChange, onBlur, value } }) => (
                  <View
                    ...
                    } rounded-2xl px-5 py-3 mb-2 bg-white flex-row items-center`}
                  >
              ...
              />
              {errors.username && (
                <Text className="text-red-500 text-base mb-2 font-Sora">
                    ...
                    <>
                      <TouchableOpacity
                        ...
                        className={`border ${
                          errors.birthdate
                            ? "border-red-500"
                            : "border-gray-300"
                        } rounded-2xl px-5 py-3 mb-2 bg-white`}
                      >
                      ...
                      {Platform.OS === "ios" && showDatePicker && (
                        <View className="flex-row justify-end gap-3 mt-2">
                          ...
                          >
                            <Text className="text-gray-800 font-Sora">
                              Listo
                            </Text>
                          </TouchableOpacity>
                        </View>
